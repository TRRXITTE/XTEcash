...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 1724001017; // April 24th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 1724001017; // August 11th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 0; //instant
        ...
        genesis = CreateGenesisBlock(1724001017, 2288135342, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000005aa70dd580fe107daa3f3b599557e88b316210a21f137ffe93eb1c89"));
        ...
        vSeeds.emplace_back("eu.trrxitte.com."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("eu-west.trrxitte.com."); // Matt Corallo, only supports x9
