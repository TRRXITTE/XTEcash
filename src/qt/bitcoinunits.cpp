...
{
    switch (unit) {
    case Unit::XTEcash: return longName(unit);
...
{
    switch (unit) {
    case Unit::XTEcash: return 100'000'000;
...
{
    switch (unit) {
    case BitcoinUnit::XTEcash: return 0;
...
{
    switch (num) {
    case 0: return BitcoinUnit::XTEcash;
